...
# Generation date: 2026-03-20T14:36:33
...
slots.class = Slot(uri=NIST_SP_800_218.class, name="class", curie=NIST_SP_800_218.curie('class'),
                   model_uri=NIST_SP_800_218.class, domain=None, range=Optional[str])
...
slots.IdentifiedElement_class = Slot(uri=NIST_SP_800_218.class, name="IdentifiedElement_class", curie=NIST_SP_800_218.curie('class'),
                   model_uri=NIST_SP_800_218.IdentifiedElement_class, domain=IdentifiedElement, range=Optional[Union[str, "CatalogElementClassValue"]])
